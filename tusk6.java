...
public class tusk6 {
    ...
    public static String translateWord(String word){
        ...
        if((Character.toLowerCase(ar[0]) !='a') && (Character.toLowerCase(ar[0]) !='o') && (Character.toLowerCase(ar[0]) !='e') && (Character.toLowerCase(ar[0])!='i') && (Character.toLowerCase(ar[0])!='u') && (Character.toLowerCase(ar[0])!='y')){
